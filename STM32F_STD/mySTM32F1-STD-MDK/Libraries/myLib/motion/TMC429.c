...
//  }
  ...
  Read[0]=ReadWriteSPI1(SPI_DEV_TMC429, Write[0], FALSE);
  Read[1]=ReadWriteSPI1(SPI_DEV_TMC429, Write[1], FALSE);
  Read[2]=ReadWriteSPI1(SPI_DEV_TMC429, Write[2], FALSE);
  Read[3]=ReadWriteSPI1(SPI_DEV_TMC429, Write[3], TRUE);
}
...
{
  return ReadWriteSPI1(SPI_DEV_TMC429, 0x01, TRUE);
}
