...
//IIC
#define IIC_SDA_IN()  {GPIOB->CRL&=0XFFFF0FFF;GPIOB->CRL|=0X000008000;}
#define IIC_SDA_OUT() {GPIOB->CRL&=0XFFFF0FFF;GPIOB->CRL|=0X000003000;}

#define IIC_SCL    			PBout(4) //SCL
#define IIC_SDA    			PBout(3) //SDA	 
#define IIC_READ_SDA   	PBin(3)  //输入SDA 
