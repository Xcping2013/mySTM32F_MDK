...
/* Includes ------------------------------------------------------------------*/
#define N_O_MOTORS 1//3  

#define L6480_CS1_PIN			PB0//PB12	
#define L6480_BUSY1_PIN		PB1//PD8
#define L6480_FLAG1_PIN		PB1//PD9
#define L6480_RESET1_PIN	PB10//PD10
#define L6480_SW1_PIN			PB11//PE12
