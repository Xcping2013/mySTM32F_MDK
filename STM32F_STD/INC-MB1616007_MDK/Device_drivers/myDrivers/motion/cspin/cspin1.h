...
#define TRUE  (1)
	...
	#define cSPIN_nSS_Pin		GPIO_Pin_12
	#define cSPIN_nSS_Port		GPIOB
	
	#define cSPIN_BUSY_Pin		GPIO_Pin_10
	#define cSPIN_BUSY_Port		GPIOB
	
	#define cSPIN_FLAG_Pin		GPIO_Pin_11
	#define cSPIN_FLAG_Port		GPIOB
	
	#define cSPIN_PWM1_Pin		GPIO_Pin_0
	#define cSPIN_PWM1_Port		GPIOB
	
	#define cSPIN_PWM2_Pin		GPIO_Pin_1
	#define cSPIN_PWM2_Port		GPIOB
	...
	#define cSPIN_STBY_RESET_Pin    GPIO_Pin_1
	#define cSPIN_STBY_RESET_Port   GPIOB
...
/**  cSPIN signals - Used for connection with STM32 discovery kit
  *  If another control board is used, please change the following settings
  *  according to the application board wiring diagram.
  *  Do not touch if STEVAL-PCC009V2 is used, see defs for that evalboard.
  * 
  */
#ifdef STM32_VL_Discovery
	#define cSPIN_SPI			SPI1
	
	#define cSPIN_SCK_Pin		GPIO_Pin_5
	#define cSPIN_SCK_Port		GPIOA
	
	#define cSPIN_MOSI_Pin		GPIO_Pin_7
	#define cSPIN_MOSI_Port		GPIOA
	
	#define cSPIN_MISO_Pin		GPIO_Pin_6
	#define cSPIN_MISO_Port		GPIOA
	
	#define cSPIN_nSS_Pin		GPIO_Pin_4
	#define cSPIN_nSS_Port		GPIOA
	
	#define cSPIN_BUSY_Pin		GPIO_Pin_4
	#define cSPIN_BUSY_Port		GPIOC
	
	#define cSPIN_FLAG_Pin		GPIO_Pin_5
	#define cSPIN_FLAG_Port		GPIOC
	
	#define cSPIN_PWM1_Pin		GPIO_Pin_1
	#define cSPIN_PWM1_Port		GPIOA
	
	#define cSPIN_PWM2_Pin		GPIO_Pin_0
	#define cSPIN_PWM2_Port		GPIOB
	
	/* List all the peripherals, which CLKs have to be enabled! */
	#define cSPIN_PERIPHERAL_CLKs_APB1	(0x00)
	#define cSPIN_PERIPHERAL_CLKs_APB2	(RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOB | RCC_APB2Periph_GPIOC | RCC_APB2Periph_SPI1)
#endif

/**  cSPIN signals - Used for connection with ST_CSPIN_6480H_DISCOVERY 
  */

#ifdef ST_CSPIN_6480H_DISCOVERY
	#define cSPIN_SPI		SPI1
	...
	#define cSPIN_BUSY_Pin		GPIO_Pin_11
	#define cSPIN_BUSY_Port		GPIOB

	#define cSPIN_FLAG_Pin		GPIO_Pin_10
	#define cSPIN_FLAG_Port		GPIOB
	...
	#define cSPIN_PWM1_Pin		GPIO_Pin_3
	#define cSPIN_PWM1_Port		GPIOA

	#define SW_MOTOR_Pin            GPIO_Pin_0
	#define SW_MOTOR_Port	        GPIOA

	#define cSPIN_SW_Pin            GPIO_Pin_4
	#define cSPIN_SW_Port	        GPIOC
	...
	#define cSPIN_STBY_RESET_Pin    GPIO_Pin_5
	#define cSPIN_STBY_RESET_Port   GPIOC
    
        #define TIM_PWM                 TIM5
   
        /* List all the peripherals, which CLKs have to be enabled! */
        /* Note : RCC_APB2Periph_AFIO is mandatory for interrupt enabling */
        #define cSPIN_PERIPHERAL_CLKs_APB1      (RCC_APB1Periph_TIM5)
	#define cSPIN_PERIPHERAL_CLKs_APB2	(RCC_APB2Periph_SPI1 | \
